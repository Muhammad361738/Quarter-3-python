...
# st.write("Transfrom Your Files Between CSV and Excel formates with built in data cleaning and visualization ")


# upload_files = st.file_uploader ("Upload you files (CSV or Excel):", type=["csv","xlsx"],
...
#         st.write(f'**File Size  : **{file/1024}')
...
#                     st.write("Missing values have been")
